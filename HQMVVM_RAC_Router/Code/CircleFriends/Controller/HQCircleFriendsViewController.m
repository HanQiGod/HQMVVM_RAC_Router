//
//  HQCircleFriendsViewController.m
//  HQMVVM_RAC_Router
//
...
#import "HQCircleFriendsViewModel.h"

@interface HQCircleFriendsViewController ()
    
    @end

@implementation HQCircleFriendsViewController
...
- (void)click{
    ...
    // 发送请求
    RACSignal *signal = [[[HQCircleFriendsViewModel alloc]init].requestCommand execute:nil];
    [signal subscribeNext:^(id x) {
        
        NSLog(@"%@",x);
        NSString *customURL = @"HQMVVMRACRouter://NaviPush/TwoViewController?userId=66666&age=18";
