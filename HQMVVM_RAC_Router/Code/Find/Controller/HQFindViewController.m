...
#import "HQFindViewModel.h"

@interface HQFindViewController ()
    
    @end

@implementation HQFindViewController
...
- (void)click{
    ...
    // 发送请求
    RACSignal *signal = [[[HQFindViewModel alloc]init].requestCommand execute:nil];
