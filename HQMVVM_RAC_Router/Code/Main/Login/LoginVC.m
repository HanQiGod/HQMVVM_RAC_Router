...
- (void)requestWithURL
    {
        ...
        NSDictionary *dic = @{
                              ...
                              @"password": [HQUtils md5sssLiu:self.password.text]                          };
        
        __weak typeof(self) weakSelf = self;
        [HQNetworking postWithUrl:[NSString stringWithFormat:@"%@user_login.ashx", KHttpUrl]  params:dic success:^(id response) {
