...
typedef NS_ENUM(NSInteger, HQNetworkStatus) {
    kHQNetworkStatusUnknown           = -1,// 未知网络
    kHQNetworkStatusNotReachable      = 0, // 没网络
    kHQNetworkStatusReachableViaWWAN  = 1, // 2G，3G，4G
    kHQNetworkStatusReachableViaWiFi  = 2  // WIFI
...
typedef void(^HQResponseSuccess)(id response);
typedef void(^HQResponseError)(NSError *error);
